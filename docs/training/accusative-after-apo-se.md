# Тренажёр предлогов и винительного

Тренажёр закрепляет выбор артикля после `από` `[aˈpo]`, слитных форм
`στον / στην / στη / στο` `[ston / stin / sti / sto]` (уроки 02 и 04) и выбор
самого предлога `από / σε / με / για` `[aˈpo / se / me / ya]` (урок 06).
Нужно выбрать форму по роду слова и первому звуку после артикля — или предлог
по смыслу; после ответа показывается полная фраза и объяснение.
