...
Для новой домашки есть отдельный [короткий тренажёр урока 02](lesson-02-reading.md):
согласные, сочетания и правила ударения.
...
Набор Noji текущего урока содержит 15 карточек с теми же сочетаниями. Его
примеры перенесены в этот тренажёр, а правила `αυ` `[av/af]`, `ευ` `[ev/ef]`,
`μπ` `[b/mb]`, `ντ` `[d/nd]` и `γκ` `[g/ŋg]` сохранены как отдельные
позиционные случаи. Поэтому здесь 18 карточек сочетаний, а не второй
параллельный набор из 15.
