window.GREEK_VERBS_A_DATA = (() => {
  ...
  const phraseRows = [
    ...
    ["ex10-7", "Εσύ ___ τον διάλογο.", "διαβάζω", 1, "εσύ → -εις. Εσύ διαβάζεις τον διάλογο. [eˈsi ðiaˈvazis ton ˈðialoɣo]"],
    ...
    ["ex10-10", "Αυτοί ___ διάλειμμα τώρα.", "έχω", 5, "αυτοί → -ουν. Αυτοί έχουν διάλειμμα τώρα. [afˈti ˈehun ˈðialima ˈtora]"],
