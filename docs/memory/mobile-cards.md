...
Для регулярного повторения — [«Главное»: 9 сквозных карточек](core.md).
...
[A4 — 3 страницы](../assets/print/core-study-card-a4.pdf),
[просмотр онлайн](../assets/mobile/core/index.html).

## Карточки по урокам

[Вопросы и ответы — полный сквозной сборник](questions-answers.md):
отдельные PDF для телефона и печати, все ответы видны сразу.
...
Каждая карточка посвящена одной теме и имеет собственный заголовок.
В PDF есть закладки по темам. На двухколоночных карточках читай сначала левую
колонку сверху вниз, затем правую.

| Урок | PDF для телефона | PDF для печати | Картинки онлайн |
|---|---|---|---|
